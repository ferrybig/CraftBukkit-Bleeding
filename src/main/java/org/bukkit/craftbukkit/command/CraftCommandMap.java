...
public class CraftCommandMap extends SimpleCommandMap {
    ...
    private void buildCommand(ConfigurationSection section, CommandAbstract nmsCommand, VanillaCommand bukkitCommand, String vanillaUsage) {
        ...
        String lowerLabel = vanillaCommand.getName().toLowerCase();
        addressedCommands.put("minecraft:" + lowerLabel, vanillaCommand);
        if (bukkitCommand != null) {
            addressedCommands.put("bukkit:" + lowerLabel,bukkitCommand);
            if (DEFAULT.equals(type)) {
                vanillaCommands.put(lowerLabel, bukkitCommand);
                return;
            }
            if (BUKKIT.equals(type)) {
                vanillaCommands.put(lowerLabel, bukkitCommand);
                priorityCommands.put(lowerLabel, bukkitCommand);
                return;
            }
        ...
        vanillaCommands.put(lowerLabel, vanillaCommand);
        return;
    }
