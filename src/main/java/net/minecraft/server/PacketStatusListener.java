...
public class PacketStatusListener implements PacketStatusInListener {
    ...
    public void a(PacketStatusInStart packetstatusinstart) {
        this.networkManager.handle(new PacketStatusOutServerInfo(org.bukkit.craftbukkit.event.CraftEventFactory.handleServerListPingEvent(this.minecraftServer, this.networkManager.getSocketAddress())), new GenericFutureListener[0]); // CraftBukkit - this.minecraftServer.ay() -> handleServerListPingEvent
    }
