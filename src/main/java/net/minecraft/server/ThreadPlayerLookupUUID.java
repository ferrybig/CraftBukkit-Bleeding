    ...
    public void run() {
        ...
        try {
            ...
            if (LoginListener.a(this.a) != null) {
                ...
                if (!this.a.networkManager.isConnected() || !org.bukkit.craftbukkit.event.CraftEventFactory.handlePlayerPreLoginEvent(this.a, LoginListener.a(this.a), LoginListener.c(this.a))) {
                    return;
                }
                // CraftBukkit end
