    ...
    public boolean damageEntity(DamageSource damagesource, float f) {
        if (this.isInvulnerable()) {
            ...
            if (damagesource.getEntity() != null) {
                // CraftBukkit start
                if (CraftEventFactory.callEntityDamageEvent(damagesource.getEntity(), this, org.bukkit.event.entity.EntityDamageEvent.DamageCause.ENTITY_ATTACK, f).isCancelled()) {
                    return false;
                }
                // CraftBukkit end
